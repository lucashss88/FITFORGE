...
ActiveRecord::Schema[7.0].define(version: 2024_01_22_190939) do
  create_table "exercise_sessions", force: :cascade do |t|
    ...
    t.index ["workout_id"], name: "index_exercise_sessions_on_workout_id"
  end
  ...
  add_foreign_key "exercise_sessions", "workouts"
